...
// PayPayPayinDetailCSV is used for CSV import, all fields as *string for csvutil
// This struct is only for import mapping, not for domain logic.
type PaypayPayinDetailCSV struct {
...
func (c *PaypayPayinDetailCSV) ValidateFields() error {
...
func (c *PaypayPayinDetailCSV) Validate() error {
...
// ToPayPayPayinDetail converts the CSV record to a domain model
func (c *PaypayPayinDetailCSV) ToPayPayPayinDetail(payinFileID int) (*PaypayPayinDetail, error) {
